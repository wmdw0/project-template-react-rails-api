...
function handleSubmit(e) {
  ...
  <div>
          ...
          <Title style={{marginLeft: '25%',marginBottom: '5%', textAlign: 'center', marginLeft: '0%', fontSize: '32px', fontWeight: '700'}}>Sign in to Twitter</Title>
  ...
  <CardContainer>
      ...
      <FormField style={{marginLeft: '25%', minWidth: '100%' }}>
        <Button style={{width: '300px', backgroundColor:'black', color: 'white'}} variant="fill" color="primary" type="submit">
    ...
    <SummaryTitle3>Don't have an account? <Link style={{textDecoration: 'none'}} to='/signup'><Button style={{backgroundColor: 'white', color: 'black', border: '1px solid black'}}>Sign Up</Button></Link></SummaryTitle3>
